...
. Execute the script https://github.com/sim1984/lucene_udr/blob/main/sql/fts%24install.sql[fts$install.sql] +
to register procedures and functions in an indexed database.
For databases of the 1st SQL dialect, use the script https://github.com/sim1984/lucene_udr/blob/main/sql/fts%24install_1.sql[fts$install_1.sql]
...
* https://github.com/sim1984/lucene_udr/releases/download/1.0/fts_demo_3.0.zip[fts_demo_3.0.zip] - database for Firebird 3.0;
* https://github.com/sim1984/lucene_udr/releases/download/1.0/fts_demo_4.0.zip[fts_demo_4.0.zip] - database for Firebird 4.0.
