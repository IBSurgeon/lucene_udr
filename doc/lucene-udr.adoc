...
* https://github.com/IBSurgeon/lucene_udr/releases/download/1.1/fts_demo_3.0.zip[fts_demo_3.0.zip] - database for Firebird 3.0;
* https://github.com/IBSurgeon/lucene_udr/releases/download/1.1/fts_demo_4.0.zip[fts_demo_4.0.zip] - database for Firebird 4.0.
