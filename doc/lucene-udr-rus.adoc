...
Для баз данных 1-ого SQL диалекта используйте скрипт https://github.com/sim1984/lucene_udr/blob/main/sql/fts%24install_1.sql[fts$install_1.sql]
...
* https://github.com/sim1984/lucene_udr/releases/download/1.0/fts_demo_3.0.zip[fts_demo_3.0.zip] - база данных для Firebird 3.0;
* https://github.com/sim1984/lucene_udr/releases/download/1.0/fts_demo_4.0.zip[fts_demo_4.0.zip] - база данных для Firebird 4.0.
