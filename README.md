...
Процедура `FTS$BEST_FRAGMENTS()` возращает лучшие фрагмены текста, которые соответвуют выражению полнотекстового поиска,
...
- FTS$FRAGMENT - фрагмент текста, соотвествующий поисковой фразе.
