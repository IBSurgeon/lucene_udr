...
CREATE TABLE FTS$INDICES(
   ...
   FTS$INDEX_STATUS FTS$INDEX_STATUS DEFAULT 'N' NOT NULL,
...
CREATE TABLE FTS$INDEX_SEGMENTS(
   ...
   FTS$STORE_DATA BOOLEAN DEFAULT FALSE NOT NULL,
...
COMMENT ON COLUMN FTS$INDEX_SEGMENTS.FTS$STORE_DATA IS 
'Whether to store column data in the index.';
